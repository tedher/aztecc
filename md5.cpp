/*----------------------------------------------------------------
 ...
 Modification by  :
   Tedi Heriyanto <tedi-h@usa.net>,Feb 2000 for use in AZTECC. 
 ...
 * MD5.CC - source code for the C++/object oriented translation and 
   ...
   Copyright (c) 1995 by Mordechai T. Abzug
*/

// first we define constants and data types
//------------------------------------------------------------
#include <stdio.h>
#include <string.h>
...
//----------------------------------------------------------------------
// now come internal MD5 routines
//
...
static void MD5_memcpy (POINTER output, POINTER input, 
			       unsigned int len)
{
  unsigned int i;
...
static void MD5_memset (POINTER output, int value, 
			       unsigned int len)
{
  unsigned int i;
...
// return hash value in 16 byte binary array 
unsigned char* MD5_raw_digest (char *string)
{
  MD5_CTX context;
...
// return hash value in 33-byte ascii hex
char* MD5_hex_digest (char *string)
{
  MD5_CTX context;
  unsigned char digest[16];
  char *s=new char[33];
